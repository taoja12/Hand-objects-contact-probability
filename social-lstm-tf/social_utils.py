...
class SocialDataLoader:
    ...
    def __init__(self, batch_size=50, seq_length=5, maxNumPeds=3, datasets=[0, 1, 2, 3, 4], forcePreProcess=False):
        """
        ...
        #                   './data/ucy/univ']
        # self.data_dirs = ['./data/eth/univ', './data/eth/hotel']
        self.data_dirs = ['./data/my_data/gong', './data/my_data/tao', './data/my_data/zheng',
                          './data/my_data/zeng', './data/my_data/yan', './data/my_data/yang', './data/my_data/xu',
                          './data/my_data/ran', './data/my_data/zhu', './data/my_data/tong']
        ...
        data_file = os.path.join(self.data_dir, "mysocial-trajectories.cpkl")
