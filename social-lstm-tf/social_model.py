...
class SocialModel(nn.Module):
    ...
    def __init__(self, args, infer=False):
        ...
        for seq, frame in enumerate(frame_data):
            ...
            # social_tensor = self.getSocialTensor(current_grid_frame_data, self.output_states)  # MNP x (GS**2 *
            # RNN_size) NOTE: Using a tensor of zeros as the social tensor
    ...
    def sample(self, sess, traj, grid, dimensions, true_traj, num=10):
        ...
        for t in range(num):
            ...
            # print cost Output is a list of lists where the inner lists contain matrices of shape 1x5. The outer
            # list contains only one element (since seq_length=1) and the inner list contains maxNumPeds elements
            # output = output[0]
