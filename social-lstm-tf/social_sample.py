...
def main():
    ...
    with open(os.path.join('save/my_socialmodel', 'mysocial_config.pkl'), 'rb') as f:
    ...
    ckpt = tf.train.get_checkpoint_state('save/my_socialmodel')
    ...
    with open(os.path.join('save/my_socialmodel', 'social_results.pkl'), 'wb') as f:
